...
Promise.all([
	d3.csv("Brittany_template/USvideos_between_1_and_80M_views_likes_dislikes_comments.csv"),
	d3.csv("Brittany_template/GBvideos_between_1_and_80M_views_likes_dislikes_comments.csv"),
